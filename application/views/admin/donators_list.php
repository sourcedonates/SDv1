	<section id="main" class="column">
            ...
            <?php endif; ?>
            <?php if(in_array('donators_view',$permissions)):?>
		<article class="module width_full">
		<header><h3 class="tabs_involved">Donator List</h3>
		<ul class="tabs">
                <li><a href="#tab1">Waiting</a></li>
		...
		<div class="tab_container">
			...
			<tbody>
                            <?php if($donators_waiting->num_rows > 0): ?>
                            <?php foreach($donators_waiting->result() as $donator): ?>
                                <tr> 
			...
			<tbody>
                            <?php if($donators_added->num_rows > 0): ?>
                            <?php foreach($donators_added->result() as $donator): ?>
                                <tr> 
   				<td><input type="checkbox"></td> 
    				<td><?=$donator->nickname?></td> 
    				<td><?=$donator->email?></td>
			...
			<tbody> 
                            <?php if($donators_expired->num_rows > 0): ?>
                            <?php foreach($donators_expired->result() as $donator): ?>
                                <tr> 
   				<td><input type="checkbox"></td> 
    				<td><?=$donator->nickname?></td> 
    				<td><?=$donator->email?></td>
