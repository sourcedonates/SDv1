...
<div class="container content" role="main">
      ...
      <section class="status clearfix">
        ...
        <article class="box succes clearfix">
          ...
          <div class="message float-left">
            <h2>Succes!</h2>
            <p>
              Your donation is succesfully stored and will be processed. When its processed you will receive a confirmation e-mail
            </p>
          </div>
        </article>

        <p class="succes">(note: the process normally takes no longer than a few seconds. but in some cases it could take up to 24 hours)</p>
